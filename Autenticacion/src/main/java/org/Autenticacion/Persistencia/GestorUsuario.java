 ...
 * distintas operaciones. Es la encargada de realizar todas las consultas SQL
 * de lectura, eliminación, modificación y adición.
 *
 * @author in4mates
 * @version 1.0
 */
...
public class GestorUsuario {
	...
	/**
	 * Array list que contendrá a los distintos usuarios que se lean de la
	 * base de datos.
	 **/
	private ArrayList<Usuario> listaUsuarios;

	/**
	 * Constructor por defecto. Realiza la creacion de la lista vacía
	 * de usuarios.
	 */
	 ...
	 *
	 * @return Lista de los distintos usuarios que se cargaron en la lista
	 * con anterioridad.
	 */
	 ...
	 * si este realiza la operación de manera correcta se obtendrá un valor
	 * de true como resultado de la ejecución del metodo.
	 *
	...
	public boolean insert(Usuario usuario) {
		boolean correcto = false;
		try {
			Agente.getAgente().modificar("INSERT INTO "
					+ "usuarios VALUES ('"
					+ usuario.getNombre() + "'," + "'"
					+ usuario.getPassword()
					+ "','" + usuario.getTipo() + "')");
