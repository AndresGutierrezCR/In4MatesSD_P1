...
/**
 * Clase Agente. Utilizada para realizar la conexión y las
 * distintas interacciones con la base de datos.
 * Solo podrá crearse un agente a la vez y controlaremos
 * esto mediante la instancia del agente se realizara
 * la conexión a la base de datos que estará contenida en un
 * fichero access y se hará uso de los drivers necesarios
...
public class Agente {
	...
	/**
	 * Constructor que creará y devolverá un agente en caso
	 * de que no exista uno previamente, si existe un
	...
	/**
	 * Realiza la conexión con la base de datos mediante
	 * el uso del driver y de la url.
	 * @throws Exception .
	 */
	...
	/**
	 * Comunica a la base de datos la consulta SQL de modificación
	 * que ha recibido el agente por parte del gestor.
	 * @throws Exception .
	 * @throws SQLException .
	 * @param SQL (Consulta SQL de modificación sobre la base de datos).
	 * @return Resultado de la consulta SQL (si esta se ha realizado
	 * de manera correcta).
	 */
    ...
    /**
	 * Comunica a la base de datos la consulta SQL de lectura de datos
	 * que ha sido entregada al agente por el gestor.
	 * @throws Exception .
	 * @throws SQLException .
	 * @param SQL (Consulta SQL de lectura de datos sobre la base de datos).
	 * @return Resultado de la consulta SQL (Datos obtenidos de la
	 * base de datos).
	 */
