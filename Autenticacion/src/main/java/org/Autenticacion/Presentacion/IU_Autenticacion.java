...
public class IU_Autenticacion extends JPanel {
	...
	/**
	 * Contenedor de texto donde se escribira la contrase�a de usuario.
	 **/
	...
	/**
	 * Setter setTxtPassword que inserta en el campo de texto del password una cadena con la contrase�a.
	 *
	 * @param String pass (contrase�a de usuario a poner en el campo de texto de password).
	 */
