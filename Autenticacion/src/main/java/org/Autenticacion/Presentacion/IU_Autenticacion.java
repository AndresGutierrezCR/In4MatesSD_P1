...
/**
 * Clase IU_Autenticacion. Contiene la interfaz de autenticación que será
 * utilizada por los usuarios para identificarse en la aplicación y poder hacer
 * uso de ella.
 *
 * @author in4mates
 * @version 1.0
...
public class IU_Autenticacion extends JPanel {
	...
	/**
	 * Boolean que indica si el proceso de autenticación se ha
	 * realizado de manera correcta o incorrecta.
	 **/
	 ...
	 * Getter autenticado.
	 *
	 * @return autenticado (valor booleano de si la autenticación es
	 * correcta o no).
	 */
	...
	/**
	 * Setter setTxtNombre que inserta en el campo de texto del nombre una
	 * cadena con el nombre.
	 *
	 * @param nombre (nombre de usuario a poner en el campo de texto
	 * de nombre).
	 */
	...
	/**
	 * Setter setTxtPassword que inserta en el campo de texto
	 * del password una cadena con la contraseña.
	 *
	 * @param pass (contraseña de usuario a poner en el campo de texto
	 * de password).
	 */
	...
	/**
	 * Método que realiza la comprobación de si el usuario existe y se
	 * corresponde con uno valido de la base de datos.
	 *
	 * @return Valor a true o a false en función de si
	 * los datos introducidos pertenecen a un usuario almacenado
	 * en la base de datos.
	 */
